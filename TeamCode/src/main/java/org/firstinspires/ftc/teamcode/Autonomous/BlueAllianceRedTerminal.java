...
@Autonomous
public class BlueAllianceRedTerminal extends LinearOpMode {
...
/*
        ...
        */
        robot.dt.move(0.7, 7, Drivetrain.moveType.DRIVE, 0.4, this);
        robot.dt.move(0.7, (tileLength * 2) + 17, Drivetrain.moveType.STRAFE, 2.4, this);
        robot.dt.turn(0.7, -19.6, 0.5, this);
//        robot.dt.move(0.7, -3.2, Drivetrain.moveType.DRIVE, 0.3, this);
        ...
        robot.dt.move(0.7, tileLength + 4.4, Drivetrain.moveType.DRIVE, 1, this);
        if (parkLocation == Vision.pLocation.LOCATION1) {
